    ...
    try {
      ...
      for (var provinceDoc in provincesSnapshot.docs) {
        ...
        if (distanceInMeters <= 90000) {
          ...
          deleteGift();
          sendNotifiction(currentUserId, userSnapshot['name'] ,userId,'Your gift has been opend' );
          update();
        }
      }
    } catch (xerroe) {
...
Future  deleteGift() async {
  ...
  Future <void> sendNotifiction(String userId, String nameuser,String receiverId ,String action) async {
